...
class InstanceConfig:
    ...
    def _get_mib_builder(cls, mibs_path):
        if cls._mib_builder is None:
            cls._mib_builder = MibBuilder()
            if mibs_path:
                cls._mib_builder.addMibSources(DirMibSource(mibs_path))
            cls._mib_instrum = MibInstrumController(cls._mib_builder)
            cls._message_dispatcher = MsgAndPduDispatcher(cls._mib_instrum)
        return cls._mib_builder, cls._mib_instrum, cls._message_dispatcher
    ...
    def create_snmp_engine(cls, mibs_path):
        ...
        """
        mib_builder, instrum_controller, message_dispatcher = cls._get_mib_builder(mibs_path)
